...
Shader "Hidden/Kvant/Swarm/Kernel"
{
    ...
    {
        p = p * _NoiseParams.x + _FrameTime.x * _NoiseParams.z + _RandomSeed;
    ...
    float4 frag_update_position(v2f_img i) : SV_Target 
    {
        ...
        p.xyz += lerp(_Flow, v, u_0) * _FrameTime.y;
    ...
    float4 frag_update_velocity(v2f_img i) : SV_Target 
    {
        ...
        // Damping
        v *= (1.0 - _Damp * _FrameTime.y);

        // Acceleration
        v += acs * acf * _FrameTime.y;
